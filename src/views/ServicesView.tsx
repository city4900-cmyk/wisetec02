...
export const ServicesView: React.FC<ServicesViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-10">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-slate-900 rounded-2xl p-8 sm:p-12 text-white text-left relative overflow-hidden shadow-xl">
        <div className="relative z-10 max-w-3xl space-y-3">
          ...
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
            구조물의 내부와 표면 결함을 정밀 판독하는 비파괴검사(NDT)와 산업안전보건법 제98조에 따른 법정 자율안전검사 위탁을 통해 무재해 현장을 완성합니다.
          </p>
        </div>
      </div>
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 sm:p-12 text-white space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
              {[
                ...
                { step: '04', title: '정밀 비파괴 탐상', desc: 'RT/UT/MT/PT/LT 표준 검사' },
      ...
      {/* 2. Safety Inspection Tab (자율안전검사) */}
      {activeSubTab === 'safety' && (
        <div className="space-y-12 animate-in fade-in duration-200">
          {/* Safety Overview Bar */}
          <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
            ...
            <div className="space-y-4 text-sm text-slate-700 leading-relaxed max-w-4xl">
              <p>
                <strong>산업안전보건법 제98조(자율안전검사 프로그램 등)</strong>에 따라 유해하거나 위험한 기계·기구 및 설비를 사용하는 사업주는 안전인증 기준을 충족하는지 정기적으로 검사해야 합니다.
              </p>
              <p>
